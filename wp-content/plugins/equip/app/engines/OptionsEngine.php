					...
					<footer class="equip-footer stuck">
						<div class="footer-inner">
							<a href="#" class="equip-logo">
								...
								<img src="<?php echo EQUIP_ASSETS_URI . '/img/equip-logo-mobile.svg';?>" class="logo-mobile" alt="Equip">
							</a>
							<div class="equip-btn-group">
								<img src="<?php echo EQUIP_ASSETS_URI . '/img/loader.gif'; ?>" alt="Loading" class="equip-loader" style="display: none;">
