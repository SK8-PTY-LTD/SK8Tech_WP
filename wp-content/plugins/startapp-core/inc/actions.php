			...
			<div class="pswp__scroll-wrap">
				...
				<div class="pswp__ui pswp__ui--hidden">
					<div class="pswp__top-bar">
						...
						<button class="pswp__button pswp__button--close" title="<?php esc_html__( 'Close (Esc)', 'startapp' ); ?>"></button>
						<button class="pswp__button pswp__button--share" title="<?php esc_html__( 'Share', 'startapp' ); ?>"></button>
						<button class="pswp__button pswp__button--fs" title="<?php esc_html__( 'Toggle fullscreen', 'startapp' ); ?>"></button>
						<button class="pswp__button pswp__button--zoom" title="<?php esc_html__( 'Zoom in/out', 'startapp' ); ?>"></button>
					...
					<button class="pswp__button pswp__button--arrow--left" title="<?php esc_html__( 'Previous (arrow left)', 'startapp' ); ?>"></button>
					<button class="pswp__button pswp__button--arrow--right" title="<?php esc_html__( 'Next (arrow right)', 'startapp' ); ?>"></button>
