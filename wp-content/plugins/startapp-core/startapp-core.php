...
function startapp_core_front_scripts() {
	...
	wp_register_script( 'googleapis-maps', '//maps.googleapis.com/maps/api/js?key=AIzaSyA5DLwPPVAz88_k0yO2nmFe7T9k1urQs84', null, null );
	wp_register_script( 'gmap3', STARTAPP_CORE_URI . '/js/vendor/gmap3.min.js', array( 'googleapis-maps' ), null, true );
	wp_register_script( 'isotope', STARTAPP_CORE_URI . '/js/vendor/isotope.pkgd.min.js', array( 'jquery' ), null, true );
