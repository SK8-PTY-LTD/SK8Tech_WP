...
function lfb_saveItem() {
    ...
    jQuery('#lfb_winItem').find('input[name="shortcode"]').parent().removeClass('has-error');
...
function lfb_addShowStepInteraction(data) {
    ...
    jQuery.each(lfb_steps, function () {
        ...
        jQuery.each(step.items, function () {
            var item = this;
            if (item.type != 'richtext' && item.type != 'colorpicker' && item.type != 'shortcode' && item.type != 'separator') {
        ...
        success: function (fields) {
            ...
            if (fields != "[]") {
                ...
                jQuery.each(fields, function () {
                    ...
                    $tr.append('<td>' +
                            '<a href="javascript:" onclick="lfb_editItem(' + field.id + ');" class="btn btn-primary btn-circle"><span class="glyphicon glyphicon-pencil"></span></a>' +
                            '<a href="javascript:" onclick="lfb_removeItem(' + field.id + ');" class="btn btn-danger btn-circle"><span class="glyphicon glyphicon-trash"></span></a>' +
                            '</td>');
