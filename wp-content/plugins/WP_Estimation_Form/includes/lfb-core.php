                        ...
                        if (!in_array($formID, $formsDone)) {
                            ...
                            if ($form) {
                                ...
                                if ($form->gmap_key != "") {
                                    ...
                                    if ($chkMap) {
                                        wp_register_script($this->_token . '-gmap', '//maps.googleapis.com/maps/api/js?key=' . $form->gmap_key, array());
    ...
    private function generateItemHtml($dataItem,$form,$dataSlide, $isFinalStep) {
        ...
        if ($chkDisplay) {
            ...
            if ($dataItem->type == 'picture') {
                ...
                $response .= '<div class="form-group">';
                $response .= '<label>' . $dataItem->title . '</label>
                <input type="text" data-mintime="'.$dataItem->minTime.'" data-maxtime="'.$dataItem->maxTime.'" data-itemid="' . $dataItem->id . '"  ' . $showInSummary . '  ' . $hideQtSummary . '   ' . $useShowConditions . ' ' . $showConditions . ' ' . $showConditionsOperator . '  class="form-control lfb_timepicker" ' . $itemRequired . ' data-title="' . $dataItem->title . '" data-originaltitle="' . $originalTitle . '"  ' . $urlTag. '/>';
