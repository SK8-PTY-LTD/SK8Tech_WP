    ...
    if( isset($_POST['idform']) ) {
        ...
        if( isset($meta_values['generate_pdf']) && !empty($meta_values['generate_pdf']) ) {
            ...
            <style>
                @page {
                  margin : 10%;
                  background-image: '.WPCF7PDF_DIR.'images/temporary-image.jpg;
                }
            </style>';
                ...
                <td align="left">
                    <div style="">
                      <div class="switch-field">
                          ...
                          <input class="switch_right" type="radio" id="switch_insert_no" name="wp_cf7pdf_settings[disable-insert]" value="false" <?php if( empty($meta_values["disable-insert"]) || (isset($meta_values["disable-insert"]) && $meta_values["disable-pdf"]=='false') ) { echo ' checked'; } ?> />
      ...
      <div class="inside openinside">
        ...
        <table class="wp-list-table widefat fixed" cellspacing="0">
            <tbody id="the-list">
                ...
                <tr>
                    <td colspan="2">
                        <textarea id="cf7pdf_html" name="wp_cf7pdf_settings[generate_pdf]" rows="45" cols="80%"><?php if( empty($meta_values['generate_pdf']) ) { echo $messagePdf; } else { echo esc_textarea($meta_values['generate_pdf']); } ?></textarea>
                    </td>
                </tr>
            </tbody>
        </table>
