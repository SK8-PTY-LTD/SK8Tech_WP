...
class EPKB_Welcome_Screen {
	...
	private function show_what_is_new() {
		...
		$content = '<p>Use visual builder to confirm your configuration changes in live preview.</p>
					<p>Please note that the preview only displays an approximate view of the KB Main or Article pages. Its main purpose is to aid you when making configuration changes.</p>';
		$image_url = 'http://www.echoplugins.com/wp-content/uploads/2017/04/epkb-plugin-welcome-new-config.jpg';
		$this->display_row( 'New Way to Configure Your KB', $content, $image_url );


		$content = '<p>Basic Layout can now display categories, sub-categories and sub-sub-categories.</p>';
		$image_url = 'http://www.echoplugins.com/wp-content/uploads/2017/04/epkb-plugin-welcome-new-3-levels.jpg';
		$this->display_row( 'Basic Layout Now with 3 Levels of Categories', $content, $image_url );


		$content = '<ul>
						<li>Switch between configuration and preview of the Main Page and Article Page.</li>
						<li>Use Demo KB switch to see how a particular layout will look with a fully populated knowledge base.</li>
					</ul>';
		$image_url = 'http://www.echoplugins.com/wp-content/uploads/2017/04/epkb-plugin-welcome-easy-config.jpg';
		$this->display_row( 'Easier Configuration', $content, $image_url );
	...
	private function show_getting_started() {
		...
		$image_url = Echo_Knowledge_Base::$plugin_url . 'img/welcome/overview.jpg';
		...
		$image_url = 'http://www.echoplugins.com/wp-content/uploads/2017/04/epkb-plugin-welcome-page-demo-data.jpg';
		...
		$image_url1 = 'http://www.echoplugins.com/wp-content/uploads/2017/04/epkb-plugin-welcome-page-intro.jpg';
		...
		$this->display_row( 'Your Initial Knowledge Base', $content, array($image_url1, $image_url2, $image_url3), $button1, $button2 );
		...
		<div class="row">
			<div class="col-3">
				...
				<ul>
					...
					<p>Use <strong>Grid Layout</strong> or <strong>Sidebar Layout</strong> for KB Main page or combine Basic, Tabs, Grid and Sidebar layouts in many cool ways.</p>
					<a class="button primary-btn" href="https://www.echoplugins.com/wordpress-plugin/elegant-layouts/" target="_blank"><?php esc_html_e( 'Learn More About Elegant Layouts', 'echo-knowledge-base' ); ?></a>
				</ul>
			...
			<div class="col-3">
				<h4>Improvements</h4>
				<ul>
					<li>Reorganized some configuration settings, grouping them by common visual elements they belong to</li>
					<li>Add Name to Feedback form</li>
				</ul>
			</div>
		</div>		<?php
	}
