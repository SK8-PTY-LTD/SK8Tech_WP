...
class EPKB_KB_Config_Specs {
	...
	public static function get_categories_display_order() {
		$base_order = array( 'alphabetical-title' => __( 'Alphabetical by Name', 'echo-knowledge-base' ),
							 ...
							 'user-sequenced' => __( 'Custom - Drag and Drop', 'echo-knowledge-base' ) );
	...
	public static function get_fields_specification( $kb_id ) {
		...
		// if kb_id is invalid default to 'zero' KB
	...
	public static function shared_configuration() {
		...
		$shared_specification = array(
			...
			'search_input_border_width' => array(
				'label'       => __( 'Search Input Border Width  ( px )', 'echo-knowledge-base' ),
			...
			'search_box_input_width' => array(
				'label'       => __( 'Search Box Input Width ( % )', 'echo-knowledge-base' ),
			...
			'section_box_height_mode' => array(
				...
				'info'        => __( 'Sets the height of article list sections:
                                        <ul>
                                            <li>If no height option is selected, the height will adjust to the amount of articles.</li>
                                            <li>If Min height selected, height will be no smaller then set height but can be larger.</li>
                                            <li>If Max height selected, height will be no greater than set height and anything more will display a scroll bar for more articles. </li>
                                        </ul>                                                                        
                                    ' ),
				'type'        => EPKB_Input_Filter::SELECTION,
				'options'     => array(
			...
			'article_list_margin' => array(
				'label'       => __( 'Article List Margin ( px )', 'echo-knowledge-base' ),
			...
			'article_list_spacing' => array(
				'label'       => __( 'Article List Spacing ( px )', 'echo-knowledge-base' ),
