...
Tags: knowledge base, documentation, documents, faqs, knowledgebase, help, admin, plugin, articles
...
Manage your documents with our easy-to-setup Knowledge Base plugin. The Knowledge Base comes with multiple layouts, styles and color themes. This flexible and simple configuration makes it easy to match it to your theme.

Help your users and customers find documents and faqs with a well-organized knowledge base that also looks professional. See a live demo of our knowledge base [here](http://www.echoknowledgebase.com/documentation/ "KB demo").
...
* KB Articles and Categories are CPTs.

= Do You Need a Simple Setup and a Basic Knowledge Base ? =
* Start right way with a basic Knowledge Base created during plugin installation.
* Choose from predefined layouts and styles to avoid dealing with templates.

= Do You Need a Highly Customizable Knowledge Base with Advanced Article Hierarchy ? =
* Organize your articles with up to three levels of categories and subcategories.
* Benefit from the most advanced yet easy-to-use configuration available.
...
Check out KB layouts and styles at [Catalogue of Knowledge Base Layouts](http://www.echoknowledgebase.com/catalogue-knowledge-base-layouts/)

Help us translate the plugin with WPML / WP-Translations Community.

---

** Expand the Knowledge Base with these great add-ons: **

** Elegant Layouts **

[Elegant Layouts](http://www.echoplugins.com/wordpress-plugin/elegant-layouts) adds Grid and Sidebar Layouts.
Use Grid Layout or Sidebar Layout for KB Main page or combine Basic, Tabs, Grid and Sidebar layouts in a variety ways.

[Explore Layout Combinations](http://www.echoknowledgebase.com/catalogue-knowledge-base-layouts/).


** Multiple Knowledge Bases **

Create multiple Knowledge Bases, one for each product, service, topic or department. Each Knowledge Base has its own article URLs, KB Main Page and admin screens. [Learn More](https://www.echoplugins.com/wordpress-plugin/multiple-knowledge-bases/).
...
1. The Basic Layout of Knowledge Base Main page

2. The Tabs Layout of Knowledge Base Main page

3. Full width Search box for themes that support full width pages

4. Frequently Asked Questions (FAQs) page

5. Order Articles and Categories in any sequence using visual builder

6. Knowledge Base configuration settings in visual builder

7. Knowledge Base Color Themes
