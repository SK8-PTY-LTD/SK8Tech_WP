...
define('WPAPPRO_UTIL',WPAPPRO_PATH.'/wp-autopost-utility-class.php');
define('WPAPPRO_FUNC',WPAPPRO_PATH.'/wp-autopost-function.php');
...
global  $wp_autopost_root,$table_prefix,$t_ap_config,$t_ap_config_option,$t_ap_config_url_list,$t_ap_updated_record,$t_ap_log,$t_autolink,$t_ap_more_content,$t_ap_flickr_img,$t_ap_flickr_oauth,$t_ap_qiniu_img,$t_ap_upyun_img,$t_ap_download_img_temp,$t_ap_watermark,$t_ap_config_group;
$wp_autopost_root = WP_PLUGIN_URL."/wp-autopost-pro/";
$t_ap_config_group = $table_prefix.'ap_config_group';
...
function wp_autopost_pro_install () {
  ...
  add_option('wp_autopost_differenceTime', '0');
  ...
  global $wpdb; $wp_autopost_db_version = '3.7';
  global $t_ap_config,$t_ap_config_option,$t_ap_config_url_list,$t_ap_updated_record,$t_ap_log,$t_autolink,$t_ap_more_content,$t_ap_flickr_img,$t_ap_flickr_oauth,$t_ap_qiniu_img,$t_ap_upyun_img,$t_ap_download_img_temp,$t_ap_watermark,$t_ap_config_group;
  $old_db_version = get_option('wp_autopost_db_version');
  require_once(ABSPATH . 'wp-admin/includes/upgrade.php');

  if(($wpdb->get_var("SHOW TABLES LIKE '$t_ap_config_group'") != $t_ap_config_group)||$wp_autopost_db_version!=$old_db_version){
     $sql = "CREATE TABLE " . $t_ap_config_group . " (
  ...
  if(($wpdb->get_var("SHOW TABLES LIKE '$t_ap_config'") != $t_ap_config)||$wp_autopost_db_version!=$old_db_version){
	...
	auto_tags CHAR(20) NULL DEFAULT NULL ,
...
include WPAPPRO_UTIL;
include WPAPPRO_FUNC;
