	...
	function startapp_entry_header() {
		...
		<header class="post-header">
			<div class="column">
				...
				if ( $categories && startapp_is_categorized_blog() ) {
					echo '&nbsp;', sprintf( esc_html_x( 'in %s', 'post categories', 'startapp' ), $categories );
				}
				unset( $categories );
		...
		<section class="post-author">
			...
			<div class="post-author-info">
				...
				echo startapp_get_text(
					nl2br( esc_html( get_the_author_meta( 'description' ) ) ),
					'<p>', '</p>'
				);
