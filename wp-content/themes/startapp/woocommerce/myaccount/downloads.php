...
<?php if ( $has_downloads ) : ?>
	...
	<div class="table-responsive">
		<table class="woocommerce-MyAccount-downloads shop_table">
			<thead>
			<tr>
						...
						<td class="<?php echo esc_attr( $column_id ); ?>"
							...
							<?php elseif ( 'download-expires' === $column_id ) : ?>
								<?php if ( ! empty( $download['access_expires'] ) ) : ?>
									<time
										datetime="<?php echo date( 'Y-m-d', strtotime( $download['access_expires'] ) ); ?>"
							...
							<?php elseif ( 'download-actions' === $column_id ) : ?>
								...
								$actions = array(
									'download' => array(
										...
										'name' => esc_html__( 'Download', 'startapp' ),
									),
								);
...
<?php else : ?>
	<div class="woocommerce-Message woocommerce-Message--info woocommerce-info">
		...
		<?php esc_html_e( 'No downloads available yet.', 'startapp' ); ?>
	</div>
<?php endif; ?>
