...
function optionsframework_load_sanitization() {
	require_once get_template_directory() . '/admin/options-sanitize.php';
}
...
function optionsframework_init() {
	...
	require_once get_template_directory() . '/admin/options-interface.php';
	require_once get_template_directory() . '/admin/options-medialibrary-uploader.php';
...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('Nexus', 'options_framework_theme'), __('Nexus', 'options_framework_theme'), 'edit_theme_options', 'options-framework','optionsframework_page');
...
function optionsframework_load_scripts($hook) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => __( 'Clear' , 'my-text-domain'),
			'defaultString' => __( 'Default' , 'my-text-domain'),
			'pick' => __( 'Select Color' , 'my-text-domain')
		);
	...
	<div>
		<div id="optionsframework-metabox" class="metabox-holder">
			...
			<div id="optionsframework" class="postbox">
				...
				<input type="submit" class="button-primary button-primary-top" name="update" value="<?php esc_attr_e( 'Save Options', 'options_framework_theme' ); ?>" />
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Nexus', 'options_framework_theme' ),
